...
// as its not in an arrow function it will be act normally 
//
// 2. What is "this" when joe.scopeArrow() is invoked?
// the enclosing scope , window of the webiste and its the global object of the website and JS adds value of undefined to it 
//
// 3. Explain why "this" is different when an arrow function is used.
//
// because it uses the enclosing scope of the surroinding 